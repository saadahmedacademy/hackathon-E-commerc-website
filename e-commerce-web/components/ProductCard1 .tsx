...
export const ProductCard1  = (items :any) => {
  return (
         <div
              className="flex-shrink-0 w-64 bg-white rounded-lg shadow space-y-3 pb-5"
            >
              {/* Image */}
              <div className="relative w-full h-40 px-2 py-1 bg-gray-200">
                ...
                />
                <p className="text-red-500 font-bold absolute left-2 top-2">
                  {items.discount}
                </p>
              ...
              <div className="flex items-center gap-2 px-4">
                ...
                <s className="text-gray-500 text-sm">$160</s>
              </div>
              <div className="flex items-center gap-2 px-4">
